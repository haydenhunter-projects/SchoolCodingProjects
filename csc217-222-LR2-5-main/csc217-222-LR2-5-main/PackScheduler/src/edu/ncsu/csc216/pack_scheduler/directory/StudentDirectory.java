...
public class StudentDirectory {
	 ...
	 * @throws IllegalArgumentException if password is invalid or are not matched
	...
	/**
	 * Returns the required elements from studentId If none are found in the
	 * directory nothing is returned
	 * 
	 * @param id Student id used to locate from the directory.
	 * @return String element of the array which is required from the directory.
	 */
