 ...
 * files, loading existing files, saving files and quitting. Depending on user
 * actions, other JPanels are loaded for the different ways users interact with
 * the UI.
 * 
...
public class WolfHireGUI extends JFrame implements ActionListener {
	...
	/**
	 * Menu item for loading a file containing one or more Positions and their
	 * Applicants.
	 */
	...
	/**
	 * Constructs a WolfHireGUI object that will contain a JMenuBar and a JPanel
	 * that will hold different possible views of the data in the WolfHire system.
	 */
	public WolfHireGUI() {
		super();
	 ...
	 * position and it's list of applications
	 * 
	 * @author Dr. Sarah Heckman (sarah_heckman@ncsu.edu)
	 */
	private class PositionListPanel extends JPanel implements ActionListener {
		...
		/**
		 * ApplicationTableModel is the object underlying the JTable object that
		 * displays the list of applications to the user.
		 * 
		 * @author Dr. Sarah Heckman (sarah_heckman@ncsu.edu)
		 */
		private class ApplicationTableModel extends AbstractTableModel {
			...
			/**
			 * Updates the given model with application information from the WolfHire
			 * system.
			 * 
	...
	/**
	 * Inner class that creates the look and behavior for the JPanel that interacts
	...
	/**
	 * Inner class that creates the look and behavior for the JPanel that interacts
	 * with an application in the rejected state.
	 * 
	 * @author Dr. Sarah Heckman (sarah_heckman@ncsu.edu)
	 */
	...
	/**
	 * Inner class that creates the look and behavior for the JPanel that interacts
	 * with an application in the ReviewingState.
	 * 
	 * @author Dr. Sarah Heckman (sarah_heckman@ncsu.edu)
	 */
	...
	/**
	 * Inner class that creates the look and behavior for the JPanel that interacts
	 * with an application in the InterviewingState.
	 * 
	 * @author Dr. Sarah Heckman (sarah_heckman@ncsu.edu)
	 */
	...
	/**
	 * Inner class that creates the look and behavior for the JPanel that interacts
	 * with an application in the ProcessingState.
	 * 
	 * @author Dr. Sarah Heckman (sarah_heckman@ncsu.edu)
	 */
	...
	/**
	 * Inner class that creates the look and behavior for the JPanel that interacts
	 * with an application in the HiredState.
	 * 
	 * @author Dr. Sarah Heckman (sarah_heckman@ncsu.edu)
	 */
	...
	private class ApplicationPanel extends JPanel {
		...
		public void setApplicationInfo(int id) {
			...
			if (application == null) {
				...
				// Set the border information with the position name, application id, and
				// current state
				String positionName = WolfHire.getInstance().getActivePositionName();

				Border lowerEtched = BorderFactory.createEtchedBorder(EtchedBorder.LOWERED);
				TitledBorder border = BorderFactory.createTitledBorder(lowerEtched,
						positionName + "-  Application #" + application.getId());
				setBorder(border);
	...
	/**
	 * Inner class that creates the look and behavior for the JPanel that allows for
	...
	private class AddApplicationPanel extends JPanel implements ActionListener {
		...
		/**
		 * Creates the JPanel for adding new applications to the position.
		 */
