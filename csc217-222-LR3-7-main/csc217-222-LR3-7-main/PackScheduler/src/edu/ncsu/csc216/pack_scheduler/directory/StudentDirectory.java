...
public class StudentDirectory {
	...
	/**
	 * Loops through the studentDirectory and looks for a student with 
	 * the same id as the given id. 
	 * @param id the id to look for in studentDirectory
	 * @return if a student is found with a matching id, return the student object
	 * if no student is found with a matching id, return null
	 */
