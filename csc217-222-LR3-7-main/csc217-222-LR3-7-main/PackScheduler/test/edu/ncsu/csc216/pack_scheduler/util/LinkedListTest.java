...
class LinkedListTest {
	...
	void testAdd() {
		...
		assertFalse(a1.listIterator().hasPrevious());
		assertTrue(a1.listIterator(2).hasPrevious());
		assertThrows(IndexOutOfBoundsException.class, 
				() -> a1.listIterator(-1).hasPrevious());
		
		
		assertEquals(0, a1.listIterator(1).previousIndex());
		assertEquals(1, a1.listIterator(1).nextIndex());
		
		assertEquals("P", a1.listIterator(1).previous());
